...
#SBATCH --job-name=CellRanger_BM_cluster
#SBATCH --partition=fast
#SBATCH --cpus-per-task=6
#SBATCH --nodes=1 
#SBATCH --mem MaxMemPerNode
#SBATCH -t 40:00:00 
#SBATCH -o logs/CellRanger_BM_cluster.out
#SBATCH -e logs/CellRanger_BM_cluster.err
...
WKD=$ROOTDIR'/CRISPR_screening_mESCs_ABigas/scRNAseq_Sorted_BM'
...
# --nosecondary was deleted from exec to generate cluster output

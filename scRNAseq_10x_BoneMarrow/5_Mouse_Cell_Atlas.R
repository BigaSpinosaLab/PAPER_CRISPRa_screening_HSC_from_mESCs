...
libraries <- c("knitr", "ggplot2", "data.table", "SingleCellExperiment", "dplyr", 
               "stringr", "ggpubr", "Seurat", "glmGamPoi", "clustree", "multtest",
               "metap","ComplexHeatmap", "RColorBrewer", "SingleR", "scmap") 
